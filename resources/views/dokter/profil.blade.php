...
<head>
    ...
    <link rel="stylesheet" href="style/dokter/profil.css">
        ...
        <div class="container">
            ...
            <div class="position-relative">
                <div class="position-absolute top-0 end-10">
                    <a href="profil">
                        <img src="{{ asset('assets/profildokter/' . Auth::user()->image) }}" class="image rounded-circle" type="button" alt="user"
                    ...
                    <form>
                        <div class="col">
                            <img class="img-profile mx-auto d-block rounded-circle"
                                src="{{ asset('assets/profildokter/'. Auth::user()->image) }}" alt="user" style="width: 200px; height: 200px; padding: 10px; margin: 0px;">
                            <a class="btn btn-success" href="/updatefoto-dokter">Update Foto</a>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <a type="button" class="btn btn-warning" href="/updateprofil-dokter">
                                    Update Profile
                                </a>
                            </div>
                        </div>
