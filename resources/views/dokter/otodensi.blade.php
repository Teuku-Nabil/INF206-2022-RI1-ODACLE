...
<head>
    ...
    <link rel="stylesheet" href="style/dokter/ortodensi.css">
...
<body>
    <section>
        <h1>Spesialis Ortodensi</h1> {{-- tinggal tambah nama aja dari controllernya --}}
        ...
        <div class="data-dokter">
            ...
            <div class="data-rinci">
                ...
                <ul>
                    <li><a href="#" class="btn">Senin   &ensp; 14.00 - 18.00</a></li>
                    <li><a href="#" class="btn">Rabu &ensp;  08.00 - 12.00</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="data-dokter">
            ...
            <div class="data-rinci">
                ...
                <ul>
                    <li><a href="#" class="btn">Kamis &ensp; 08.00 - 12.00</a></li>
