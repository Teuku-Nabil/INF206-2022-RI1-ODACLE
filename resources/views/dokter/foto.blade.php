...
<head>
    ...
    <link rel="stylesheet" href="style/dokter/updateprofil.css">
        ...
        <div class="container">
            ...
            <div class="position-relative">
                <div class="position-absolute top-0 end-10">
                    <a href="profil">
                        <img src="{{ asset('assets/profildokter/' . Auth::user()->image) }}" class="image rounded-circle"
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('fotodokter.upload') }}" enctype="multipart/form-data">
                            @csrf

                            <div class="form-group row">
                                <label for="image" class="col-md-4 col-form-label text-md-right">Masukkan Foto</label>
                                <img alt="image" src="{{ asset('assets/profildokter/' . Auth::user()->image) }}" class="img-fluid rounded-circle"
