                    ...
                    <div class="form-group ">
                        ...
                        <div class="dropdown d-sm-inline" style="margin-left:20px">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                ...
                                <li><a class="dropdown-item" href="#">08.00-10.00</a></li>
                                <li><a class="dropdown-item" href="#">10.00-12.00</a></li>
                                <li><a class="dropdown-item" href="#">14.00-16.00</a></li>
                                <li><a class="dropdown-item" href="#">16.00-18.00</a></li>
                            </ul>
                        </div>
                    </div>
