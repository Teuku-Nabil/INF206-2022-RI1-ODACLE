    ...
    <body>
            ...
            <div class="antrian justify-content-center">
                ...
                <div class="content-antrian">
                    ...
                    <div class="content-grup">
                        <label class="Lokasi" for="waktu" style="font-size: 20px"><strong>Lokasi</strong></label>
                        <p>xxx</p>
                    </div>
                    <div class="content-grup">
                    ...
                    <div class="content-grup">
                        <label class="label-antrian" for="nomor-antrian" style="font-size: 20px"><strong>Nomor Antrian</strong></label>
                        <p>xxx</p>
                    </div>
                </div>
                <div class="button-antrian">
                    <center><button type="submit" class="button-lanjut">Selanjutnya</button></center>
                    <center><button type="submit" class="button-cetak">cetak</button></center>
                </div>
            </div>
